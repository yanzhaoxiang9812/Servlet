...
<center>
    ...
    <h3 style="color: red">HttpSession接口</h3><br><a href="Servlet5">HttpSessionTest</a><br>
    <h3 style="color: red">HttpServletRequest接口</h3><br><a href="Servlet7">HttpServletRequestTest</a><br>
</center>
</body>
</html>